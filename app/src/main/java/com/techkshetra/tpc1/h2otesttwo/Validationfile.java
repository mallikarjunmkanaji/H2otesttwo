...
public class Validationfile {
  ...
  /*  public static boolean isValidMobile(Context context, String mobile) {
    ...
    public static boolean isValidconPassword(Context context, String conpassword){
        if (isNullOrEmpty(conpassword)) {
          showToast(context, "Please Confirm Password first");
        }
       else {
            return true;
        }
